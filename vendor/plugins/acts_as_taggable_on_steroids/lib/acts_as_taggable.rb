  ...
  module Acts #:nodoc:
    module Taggable #:nodoc:
      ...
      module InstanceMethods
        ...
        def clickable_tags
          return @clickable_tags ? @clickable_tags : nil
        end
        
        def clickable_tags=(tags_arr)
          unless tags_arr.nil?	
            @clickable_tags = []
            tags_arr.each do |a_tag|
			  n_tag =  NormalizedTag.get_normazlied_tag(a_tag.normalized_tag_id)
			  @clickable_tags << {:name=>a_tag.name, :contentable_type=>n_tag.contentable_type, :contentable_id=>n_tag.contentable_id} unless n_tag.nil? 
		    end
		  end	
        end
