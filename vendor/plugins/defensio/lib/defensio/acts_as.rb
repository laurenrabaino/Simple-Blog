  ...
  module ActsAs
    ...
    module InstanceMethods
      ...
      def audit_comment
        ...
        fields = { :user_ip      => @env['REMOTE_ADDR'] ? @env['REMOTE_ADDR'].to_s.split(",").last.strip : '127.0.0.1',
                   :referrer     => @env['HTTP_REFERER'],
                   :article_date => article.created_at ? convert_to_defensio_date(article.created_at) : 1.day.ago,
